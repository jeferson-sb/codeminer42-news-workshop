...
export const news = {
  todayHighlight: {
    ...
    abstract: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore harum voluptate impedit quos placeat officia illum perspiciatis nobis. Soluta omnis sit architecto beatae odio veniam cumque eum, sed doloribus voluptate quo esse laboriosam incidunt nostrum? Placeat natus eum tempore! Consectetur?",
    category: "World",
    poster: {
  ...
  secondaries: [
    {
      ...
      category: "BR",
      abstract: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia quidem eius ut officia at eveniet quia neque magnam voluptate sed repellendus voluptas voluptatem quibusdam, repellat sit rerum? Dignissimos, eaque animi!",
      author: {
        name: "Kaison Wyatt",
        avatar: {
          src: "https://i.pravatar.cc/48",
  ...
  opinions: [
    {
      id: "2aogm2askx",
      title: "The Paradox of Progress: How AI’s Leap Forward Could Mean a Step Back for Human Creativity",
    ...
    {
      id: "b1l9gn85",
      title: "Beyond the Hype: A Realist’s View on the Sustainable Future of Blockchain Technologies",
  ...
  categorized: {
    sports: [
      {
        ...
        abstract: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore harum voluptate impedit quos placeat officia illum perspiciatis nobis. Soluta omnis sit architecto beatae odio veniam cumque eum, sed doloribus...",
        author: {
          name: "Davis Abel",
          avatar: {
            src: "https://i.pravatar.cc/48",
      ...
      {
        id: "4mpdiyk0",
        title: "First Player to Dunk from the Free-Throw Line in an NBA Finals Game",
      ...
      {
        id: "350n056v",
        title: "Speed and Strategy: Youngest Champion in F1 History Wins Great Title",
    ...
    politics: [
      {
        id: "7upx581e9b",
        title: "Democrats grapple with the right way to talk about Biden’s immigration policies",
        slug: "democrats-grapple-with-the-right-way-to-talk-about-bidens-immigration-policies",
        poster: {
          src: "https://picsum.photos/500/300",
          alt: ""
        },
        abstract: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore harum voluptate impedit quos placeat...",
        author: {
      ...
      {
        id: "17ccccu0j1",
        title: "Government Launches Nationwide Initiative to Become a Global Leader in Renewable Energy Technology",
      ...
      {
        id: "avzjv1ar",
        title: "Japan Announces Breakthrough Policy: Nationwide Initiative to Transform Urban Centers",
